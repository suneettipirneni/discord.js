...
export function DocContainer({ name, kind, excerpt, summary, typeParams, children, extendsTokens }: DocContainerProps) {
	return (
		<>
			<div className="dark:bg-dark border-b-solid border-gray border-width-0.5 sticky top-0 bg-white px-10 py-2">
				<h2 className="m-0 flex items-center break-all font-mono dark:text-white">
